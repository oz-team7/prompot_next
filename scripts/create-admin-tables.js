...
async function createAdminTables() {
  try {
    ...
    // Execute the SQL to create admin tables
    ...
    if (error) {
      ...
      // If RPC doesn't work, we'll need to use Supabase dashboard
      console.log('\nPlease execute the following SQL in Supabase SQL Editor:');
      console.log('https://app.supabase.com/project/tlytjitkokavfhwzedml/editor');
      console.log('\nCopy the content from: supabase/migrations/003_admin_tables.sql');
      return;
    }
